...
class Game:
    ...
    @developer.setter
    def developer(self, new_title):
        if type(new_title) is str and new_title.strip() != "":
            self.__developer = new_title.strip()
        else:
            self.__developer = None
    ...
    @categories.setter
    def categories(self, new_title):
        if type(new_title) is str and new_title.strip() != "":
            self.__categories = new_title.strip()
        else:
            self.__categories = None
...
class User:
    def __init__(self, username: str, password: str):
        if not isinstance(username, str) or username.strip() == "":
            ...
            #changing this to case sensitive
